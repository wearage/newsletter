...
EXCEL_FILE = '/yourpath/usernames.xlsx'
COLUMN_NAME = 'Script1'
COLUMN_NAME = 'Script1name'
BATCH_SIZE = 4

# Путь к директории логов
LOGS_DIR = '/yourpath/Logs'
...
accounts = [{'session_name': '+79999999999'}]

# Определение начального сообщения 
initial_messages = [
    (
...
prompt_template_1 = [
    {
        ...
        "content": (
            ...
            "#Шаг 0. Задай клиенту этот вопрос, добавив к фразе как вода влияет на наше здоровье гиппер ссылку : 'Предлагаю прочитать наш гайд: [как вода влияет на наше здоровье]:(https://drive.google.com/file/d/example/view) ' "
